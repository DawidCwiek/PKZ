...
RSpec.describe 'Menus Controller', type: :request do
  ...
  let(:invalid_attributes) { { menu: attributes_for(:menu, name: nil) } }

  describe 'GET /central/:id/menus' do
  ...
  describe 'GET /central/:id/menus/:menu_id' do
  ...
  describe 'Post /central/:id/menus/' do
